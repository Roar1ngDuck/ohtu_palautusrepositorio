...
class TestKauppa(unittest.TestCase):
    ...
    def test_ostoksen_paaytyttya_tilisiirto_kutsutaan_oikeailla_parametreilla(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_uudessa_ostossa_ei_edellisen_hintaa(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
        ...
        pankki_mock.tilisiirto.assert_called_with("pekka", 42, "12345", kauppa._kaupan_tili, 2)
    ...
    def test_uusi_viitenumero_jokaiselle_maksutapahtumalle(self):
        ...
        self.assertEqual(viitegeneraattori_mock.uusi.call_count, 5)
    ...
    def test_poistetaan_korista_lisaamaton_tuote(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
        ...
        self.assertEqual(varasto_mock.palauta_varastoon.call_count, 0)
